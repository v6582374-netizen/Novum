...
- 下一阶段开发规格：[docs/phase-3-spec.md](./docs/phase-3-spec.md)
...
接下来会从文献库/PDF 闭环继续推进到 PaperQA 真实索引、文献问答、引用回链、模型配置和本地运行记录。
...
当前可以导入本地 PDF、查看真实 PDF、保存阅读页码与缩放、删除文献。索引、PaperQA 调用和科学技能执行将在后续迭代中接入。
