...
接下来会从 PaperQA 闭环继续推进到 Science Skills 技能市场、本地技能运行器、运行日志和结构化输出。
...
当前可以导入本地 PDF、查看真实 PDF、保存阅读页码与缩放、删除文献，配置 OpenAI-compatible 模型服务，并围绕当前文献发起 PaperQA 索引与问答。科学技能执行将在 Phase 4 接入。
...
5. **科学技能市场**
   - 下一阶段规格见 [docs/phase-4-spec.md](./docs/phase-4-spec.md)
   - 解析 `SKILL.md`
